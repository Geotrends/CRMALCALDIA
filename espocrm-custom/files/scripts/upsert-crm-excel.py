...
SOLICITUD_LABELS = {
    ...
    "cViaPrincipalPeticionario": "Vía principal (peticionario)",
    "cNumViaPrincipalPeticionario": "N° vía principal (peticionario)",
    "cLetraViaPrincipalPeticionario": "Letra vía (peticionario)",
    "cCuadranteViaPrincipalPeticionario": "Cuadrante vía (peticionario)",
    "cGeneradoraPeticionario": "Generadora (peticionario)",
    "cLetraGeneradoraPeticionario": "Letra generadora (peticionario)",
    "cCuadranteGeneradoraPeticionario": "Cuadrante generadora (peticionario)",
    "cPlacaPeticionario": "Placa (peticionario)",
    "cBloquePeticionario": "Bloque (peticionario)",
    "cInteriorPeticionario": "Interior (peticionario)",
    ...
    "cCorreoPeticionario": "Correo electrónico",
    "cCanalDeReportePeticionario": "Canal de reporte",
    "cRecursoTema": "Recurso / tema",
    "cAsunto": "Asunto",
    "cZonaAlcaldiaPeticionario": "Zona",
    "cFechaVencimiento": "Fecha de vencimiento",
    "cUltimaActuacion": "Última actuación",
    "cProximaActuacion": "Próxima actuación",
    "cPerjudicante": "Perjudicante / posible afectante",
    "cDocumentoPerjudicante": "Documento del perjudicante",
    "cTelefonoPerjudicante": "Teléfono del perjudicante",
    "cViaPrincipalPerjudicante": "Vía principal (infractor)",
    "cNumViaPrincipalPerjudicante": "N° vía principal (infractor)",
    "cLetraViaPrincipalPerjudicante": "Letra vía (infractor)",
    "cCuadranteViaPrincipalPerjudicante": "Cuadrante vía (infractor)",
    "cGeneradoraPerjudicante": "Generadora (infractor)",
    "cLetraGeneradoraPerjudicante": "Letra generadora (infractor)",
    "cCuadranteGeneradoraPerjudicante": "Cuadrante generadora (infractor)",
    "cPlacaPerjudicante": "Placa (infractor)",
    "cBloquePerjudicante": "Bloque (infractor)",
    "cInteriorPerjudicante": "Interior (infractor)",
