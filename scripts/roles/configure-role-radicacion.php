...
$roleNames = ['Auxiliar Administrativo · Radicador', 'Radicación', 'Radicacion'];
$role = null;
...
$readOnlyScopes = [
    ...
    'ActuacionRNMC' => ['create' => 'yes', 'read' => 'all', 'edit' => 'own', 'delete' => 'no', 'stream' => 'no'],
    'OrdenComparendo' => ['create' => 'yes', 'read' => 'all', 'edit' => 'own', 'delete' => 'no', 'stream' => 'no'],
