...
CREATE TABLE public.actuo_archivo (
    ...
    inspector_cargo character varying(200) DEFAULT 'Inspector de Polic?a para Asuntos Ambientales'::character varying,
    estado character varying(255) DEFAULT 'Pendiente'::character varying,
    created_at timestamp(0) without time zone DEFAULT NULL::timestamp without time zone,
    modified_at timestamp(0) without time zone DEFAULT NULL::timestamp without time zone,
    case_id character varying(17) DEFAULT NULL::character varying,
...
CREATE TABLE public."case" (
    ...
    assigned_user_id character varying(17) DEFAULT NULL::character varying,
    version_number bigint,
    c_canal_de_reporte_peticionario character varying(100) DEFAULT 'Seleccione una opci?n'::character varying,
    c_tipo_persona_peticionario character varying(255) DEFAULT 'Seleccione una opci?n'::character varying,
    c_documento_peticionario character varying(100) DEFAULT NULL::character varying,
    c_nombre_peticionario character varying(100),
    c_apellido_peticionario character varying(150),
    c_telefono_peticionario character varying(100),
    c_correo_peticionario character varying(200) DEFAULT NULL::character varying,
    c_direccion_peticionario character varying(255) DEFAULT NULL::character varying,
    c_municipio_peticionario character varying(100) DEFAULT 'Envigado'::character varying,
    c_barrio_peticionario character varying(100) DEFAULT 'Seleccione una opci?n'::character varying,
    c_zona_alcaldia_peticionario character varying(255) DEFAULT 'Seleccione una opci?n'::character varying,
    c_tipo_persona_perjudicante character varying(255) DEFAULT 'Seleccione una opci?n'::character varying,
    ...
    c_direccion_perjudicante character varying(255) DEFAULT NULL::character varying,
    c_barrio_perjudicante character varying(100) DEFAULT 'Seleccione una opci?n'::character varying,
    ...
    c_radicado_modo character varying(255) DEFAULT 'Autom?tico'::character varying,
    c_radicado_siglas character varying(255) DEFAULT 'Seleccione una opci?n'::character varying,
    c_radicado_anio character varying(4) DEFAULT ''::character varying,
    c_recurso_tema character varying(255) DEFAULT 'Seleccione una opci?n'::character varying,
    c_asunto character varying(255) DEFAULT 'Seleccione una opci?n'::character varying,
    c_ultima_actuacion character varying(255) DEFAULT 'Seleccione una opci?n'::character varying,
    c_proxima_actuacion character varying(255) DEFAULT 'Seleccione una opci?n'::character varying,
